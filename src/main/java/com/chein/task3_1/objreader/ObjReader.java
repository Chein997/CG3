package com.chein.task3_1.objreader;
...
public class ObjReader {
    ...
    protected static Vector3f parseVertex(final ArrayList<String> wordsInLineWithoutToken, int lineInd) {
        try {
            ...
            throw new com.chein.task3_1.objreader.ObjReaderException("Failed to parse float value.", lineInd);

        } catch(IndexOutOfBoundsException e) {
            throw new com.chein.task3_1.objreader.ObjReaderException("Too few vertex arguments.", lineInd);
        }
    }
    ...
    protected static Vector2f parseTextureVertex(final ArrayList<String> wordsInLineWithoutToken, int lineInd) {
        try {
            ...
            throw new com.chein.task3_1.objreader.ObjReaderException("Too few texture vertex arguments.", lineInd);
        }
    }
    ...
    protected static Vector3f parseNormal(final ArrayList<String> wordsInLineWithoutToken, int lineInd) {
        try {
            ...
            throw new com.chein.task3_1.objreader.ObjReaderException("Too few normal arguments.", lineInd);
        }
    }
    ...
    protected static void parseFaceWord(
        ...
        try {
            ...
            switch (wordIndices.length) {
                ...
                default -> {
                    throw new com.chein.task3_1.objreader.ObjReaderException("Invalid element size.", lineInd);
                }
            }

        } catch(NumberFormatException e) {
            throw new com.chein.task3_1.objreader.ObjReaderException("Failed to parse int value.", lineInd);

        } catch(IndexOutOfBoundsException e) {
            throw new com.chein.task3_1.objreader.ObjReaderException("Too few arguments.", lineInd);
        }
    }
}
